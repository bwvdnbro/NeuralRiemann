 ...
 * Copyright (C) 2016, 2018 Bert Vandenbroucke (bert.vandenbroucke@gmail.com)
 *
 ...
 *
 * This file is almost identical to Error.hpp in CMacIonize (Vandenbroucke &
 * Wood, 2018).
 *
 ...
 */
#define nnr_assert(condition)                                                  \
  {                                                                            \
    if (!(condition)) {                                                        \
      nnr_error("Assertion failed: \"" #condition "\"!");                      \
    }                                                                          \
  }
 ...
 */
#define nnr_assert_message(condition, s, ...)                                  \
  {                                                                            \
    if (!(condition)) {                                                        \
      nnr_error("Assertion failed: \"" #condition "\" (" s ")!",               \
                ##__VA_ARGS__);                                                \
    }                                                                          \
  }
